...
#ifdef OPEN_MPI
PyMPI_WEAK(ompi_mpi_datatype_null)
PyMPI_WEAK(ompi_mpi_packed)
PyMPI_WEAK(ompi_mpi_byte)
PyMPI_WEAK(ompi_mpi_aint)
PyMPI_WEAK(ompi_mpi_offset)
PyMPI_WEAK(ompi_mpi_count)
PyMPI_WEAK(ompi_mpi_char)
PyMPI_WEAK(ompi_mpi_wchar)
PyMPI_WEAK(ompi_mpi_signed_char)
PyMPI_WEAK(ompi_mpi_short)
PyMPI_WEAK(ompi_mpi_int)
PyMPI_WEAK(ompi_mpi_long)
PyMPI_WEAK(ompi_mpi_long_long)
PyMPI_WEAK(ompi_mpi_long_long_int)
PyMPI_WEAK(ompi_mpi_unsigned_char)
PyMPI_WEAK(ompi_mpi_unsigned_short)
PyMPI_WEAK(ompi_mpi_unsigned)
PyMPI_WEAK(ompi_mpi_unsigned_long)
PyMPI_WEAK(ompi_mpi_unsigned_long_long)
PyMPI_WEAK(ompi_mpi_float)
PyMPI_WEAK(ompi_mpi_double)
PyMPI_WEAK(ompi_mpi_long_double)
PyMPI_WEAK(ompi_mpi_c_bool)
PyMPI_WEAK(ompi_mpi_int8_t)
PyMPI_WEAK(ompi_mpi_int16_t)
PyMPI_WEAK(ompi_mpi_int32_t)
PyMPI_WEAK(ompi_mpi_int64_t)
PyMPI_WEAK(ompi_mpi_uint8_t)
PyMPI_WEAK(ompi_mpi_uint16_t)
PyMPI_WEAK(ompi_mpi_uint32_t)
PyMPI_WEAK(ompi_mpi_uint64_t)
PyMPI_WEAK(ompi_mpi_c_complex)
PyMPI_WEAK(ompi_mpi_c_float_complex)
PyMPI_WEAK(ompi_mpi_c_double_complex)
PyMPI_WEAK(ompi_mpi_c_long_double_complex)
PyMPI_WEAK(ompi_mpi_cxx_bool)
PyMPI_WEAK(ompi_mpi_cxx_cplex)
PyMPI_WEAK(ompi_mpi_cxx_dblcplex)
PyMPI_WEAK(ompi_mpi_cxx_ldblcplex)
PyMPI_WEAK(ompi_mpi_short_int)
PyMPI_WEAK(ompi_mpi_2int)
PyMPI_WEAK(ompi_mpi_long_int)
PyMPI_WEAK(ompi_mpi_float_int)
PyMPI_WEAK(ompi_mpi_double_int)
PyMPI_WEAK(ompi_mpi_longdbl_int)
PyMPI_WEAK(ompi_mpi_character)
PyMPI_WEAK(ompi_mpi_logical)
PyMPI_WEAK(ompi_mpi_integer)
PyMPI_WEAK(ompi_mpi_real)
PyMPI_WEAK(ompi_mpi_dblprec)
PyMPI_WEAK(ompi_mpi_cplex)
PyMPI_WEAK(ompi_mpi_dblcplex)
PyMPI_WEAK(ompi_mpi_logical1)
PyMPI_WEAK(ompi_mpi_logical2)
PyMPI_WEAK(ompi_mpi_logical4)
PyMPI_WEAK(ompi_mpi_logical8)
PyMPI_WEAK(ompi_mpi_integer1)
PyMPI_WEAK(ompi_mpi_integer2)
PyMPI_WEAK(ompi_mpi_integer4)
PyMPI_WEAK(ompi_mpi_integer8)
PyMPI_WEAK(ompi_mpi_integer16)
PyMPI_WEAK(ompi_mpi_real2)
PyMPI_WEAK(ompi_mpi_real4)
PyMPI_WEAK(ompi_mpi_real8)
PyMPI_WEAK(ompi_mpi_real16)
PyMPI_WEAK(ompi_mpi_complex4)
PyMPI_WEAK(ompi_mpi_complex8)
PyMPI_WEAK(ompi_mpi_complex16)
PyMPI_WEAK(ompi_mpi_complex32)
PyMPI_WEAK(ompi_request_null)
PyMPI_WEAK(ompi_mpi_op_null)
PyMPI_WEAK(ompi_mpi_op_max)
PyMPI_WEAK(ompi_mpi_op_min)
PyMPI_WEAK(ompi_mpi_op_sum)
PyMPI_WEAK(ompi_mpi_op_prod)
PyMPI_WEAK(ompi_mpi_op_land)
PyMPI_WEAK(ompi_mpi_op_band)
PyMPI_WEAK(ompi_mpi_op_lor)
PyMPI_WEAK(ompi_mpi_op_bor)
PyMPI_WEAK(ompi_mpi_op_lxor)
PyMPI_WEAK(ompi_mpi_op_bxor)
PyMPI_WEAK(ompi_mpi_op_maxloc)
PyMPI_WEAK(ompi_mpi_op_minloc)
PyMPI_WEAK(ompi_mpi_op_replace)
PyMPI_WEAK(ompi_mpi_op_no_op)
PyMPI_WEAK(ompi_mpi_group_null)
PyMPI_WEAK(ompi_mpi_group_empty)
PyMPI_WEAK(ompi_mpi_info_null)
PyMPI_WEAK(ompi_mpi_info_env)
PyMPI_WEAK(ompi_mpi_errhandler_null)
PyMPI_WEAK(ompi_mpi_errors_return)
PyMPI_WEAK(ompi_mpi_errors_abort)
PyMPI_WEAK(ompi_mpi_errors_are_fatal)
PyMPI_WEAK(ompi_mpi_instance_null)
PyMPI_WEAK(ompi_mpi_comm_null)
PyMPI_WEAK(ompi_mpi_comm_self)
PyMPI_WEAK(ompi_mpi_comm_world)
PyMPI_WEAK(ompi_message_null)
PyMPI_WEAK(ompi_message_no_proc)
PyMPI_WEAK(ompi_mpi_win_null)
PyMPI_WEAK(ompi_mpi_file_null)
#ifdef MPI_Aint_add
...
PyMPI_EXTERN int MPI_Status_c2f(MPI_Status* a0,MPI_Fint* a1);
#endif
#define _pympi__MPI_Status_c2f(c, f) ((c) && (f) ? (*(MPI_Status *)(char *)(f) = *(c), MPI_SUCCESS) : MPI_ERR_ARG)
PyMPI_LOCAL int _pympi_MPI_Status_c2f(MPI_Status* a0,MPI_Fint* a1) { _pympi_CALL(MPI_Status_c2f,a0,a1); }
#define MPI_Status_c2f _pympi_MPI_Status_c2f

#undef MPI_Status_f2c
#ifndef PyMPI_HAVE_MPI_Status_f2c
PyMPI_EXTERN int MPI_Status_f2c(MPI_Fint* a0,MPI_Status* a1);
#endif
#define _pympi__MPI_Status_f2c(f, c) ((c) && (f) ? (*(c) = *(MPI_Status *)(char *)(f), MPI_SUCCESS) : MPI_ERR_ARG)
PyMPI_LOCAL int _pympi_MPI_Status_f2c(MPI_Fint* a0,MPI_Status* a1) { _pympi_CALL(MPI_Status_f2c,a0,a1); }
