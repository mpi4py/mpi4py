...
class Comm(MPI.Comm):
    ...
    def isend(self, obj: Any, dest: int, tag: int = 0) -> Request: ...  # mypy: ignore[override]
    def ibsend(self, obj: Any, dest: int, tag: int = 0) -> Request: ...  # mypy: ignore[override]
    def issend(self, obj: Any, dest: int, tag: int = 0) -> Request: ...  # mypy: ignore[override]
    def recv(
        self,
    ...
    def irecv(  # mypy: ignore[override]
        self,
        buf: Buffer | None = None,
        source: int = ANY_SOURCE,
        tag: int = ANY_TAG,
    ...
    def mprobe(  # mypy: ignore[override]
        self,
        source: int = ANY_SOURCE,
        tag: int = ANY_TAG,
        status: Status | None = None,
    ) -> Message: ...
    def improbe(  # mypy: ignore[override]
        self,
        source: int = ANY_SOURCE,
        tag: int = ANY_TAG,
        status: Status | None = None,
