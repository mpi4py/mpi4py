...
from ..MPI import Info, Intercomm, Intracomm, Request
...
def _serialized_locked(function: Callable[P, R]) -> Callable[P, R]: ...
def _serialized_nolock(function: Callable[P, R]) -> Callable[P, R]: ...
def setup_mpi_threads() -> None: ...

_mpi_thread_serialized_lock: threading.Lock = ...
serialized: Callable[[Callable[..., R]], Callable[..., R]] = ...
...
_ThreadQueueMap: TypeAlias = _WeakKeyDict[
    threading.Thread, TaskQueue[_Item[Any] | None]
]
...
def _comm_executor_world() -> Intracomm: ...
def _comm_executor_helper(
    executor: Executor | None, comm: Intracomm, root: int
) -> None: ...
...
def waitall(
    comm: Intercomm, requests: Sequence[Request], poll: bool = False
) -> list[Any]: ...
