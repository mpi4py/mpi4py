...
class Message:
    ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    @classmethod
    def Probe(cls, comm: Comm, source: int = ANY_SOURCE, tag: int = ANY_TAG, status: Optional[Status] = None) -> Self: ...
    @classmethod
    def Iprobe(cls, comm: Comm, source: int = ANY_SOURCE, tag: int = ANY_TAG, status: Optional[Status] = None) -> Optional[Self]: ...
...
class Session:
    ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    @classmethod
    def Init(cls, info: Info = INFO_NULL, errhandler: Optional[Errhandler] = None) -> Self: ...
...
class Comm:
    ...
    def Sendrecv(self, sendbuf: BufSpec, dest: int, sendtag: int = 0, recvbuf: Optional[BufSpec] = None, source: int = ANY_SOURCE, recvtag: int = ANY_TAG, status: Optional[Status] = None) -> None: ...
    ...
    def Isendrecv(self, sendbuf: BufSpec, dest: int, sendtag: int = 0, recvbuf: Optional[BufSpec] = None, source: int = ANY_SOURCE, recvtag: int = ANY_TAG) -> Request: ...
...
def _typealign(datatype: Datatype) -> Optional[int]: ...
