...
class Datatype:
    def __new__(cls, datatype: Datatype | None = None) -> Datatype: ...
    ...
    def Get_attr(self, keyval: int) -> Union[int, Any, None]: ...
...
class Status:
    def __new__(cls, status: Status | None = None) -> Status: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
...
class Request:
    def __new__(cls, request: Request | None = None) -> Request: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
...
class Prequest(Request):
    def __new__(cls, request: Request | None = None) -> Prequest: ...
    def Start(self) -> None: ...
    @classmethod
...
class Grequest(Request):
    def __new__(cls, request: Request | None = None) -> Grequest: ...
    @classmethod
    def Start(cls, query_fn: Callable[..., None], free_fn: Callable[..., None], cancel_fn: Callable[..., None], args: tuple[Any] | None = None, kwargs: dict[str, Any] | None = None) -> Grequest: ...
    def Complete(self) -> None: ...

class Message:
    def __new__(cls, message: Message | None = None) -> Message: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
...
class Op:
    def __new__(cls, op: Op | None = None) -> Op: ...
...
class Group:
    def __new__(cls, group: Group | None = None) -> Group: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    ...
    @classmethod
    def Translate_ranks(cls, group1: Group, ranks1: Sequence[int], group2: Group | None = None) -> list[int]: ...
    @classmethod
...
class Info:
    def __new__(cls, info: Info | None = None) -> Info: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    @classmethod
    def Create(cls, items: Union[Info, Mapping[str, str], Iterable[tuple[str, str]], None] = None) -> Self: ...
    @classmethod
    ...
    def update(self, items: Union[Info, Mapping[str, str], Iterable[tuple[str, str]]] = (), **kwds: str) -> None: ...
...
class Errhandler:
    def __new__(cls, errhandler: Errhandler | None = None) -> Errhandler: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
...
class Session:
    def __new__(cls, session: Session | None = None) -> Session: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
...
class Comm:
    def __new__(cls, comm: Comm | None = None) -> Comm: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    ...
    def Gather(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecB | None, root: int = 0) -> None: ...
    def Gatherv(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecV | None, root: int = 0) -> None: ...
    def Scatter(self, sendbuf: BufSpecB | None, recvbuf: Union[BufSpec, InPlace], root: int = 0) -> None: ...
    def Scatterv(self, sendbuf: BufSpecV | None, recvbuf: Union[BufSpec, InPlace], root: int = 0) -> None: ...
    ...
    def Reduce(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec | None, op: Op = SUM, root: int = 0) -> None: ...
    ...
    def Reduce_scatter(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, recvcounts: Sequence[int] | None = None, op: Op = SUM) -> None: ...
    def Ibarrier(self) -> Request: ...
    def Ibcast(self, buf: BufSpec, root: int = 0) -> Request: ...
    def Igather(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecB | None, root: int = 0) -> Request: ...
    def Igatherv(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecV | None, root: int = 0) -> Request: ...
    def Iscatter(self, sendbuf: BufSpecB | None, recvbuf: Union[BufSpec, InPlace], root: int = 0) -> Request: ...
    def Iscatterv(self, sendbuf: BufSpecV | None, recvbuf: Union[BufSpec, InPlace], root: int = 0) -> Request: ...
    ...
    def Ireduce(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec | None, op: Op = SUM, root: int = 0) -> Request: ...
    ...
    def Ireduce_scatter(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, recvcounts: Sequence[int] | None = None, op: Op = SUM) -> Request: ...
    ...
    def Gather_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecB | None, root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Gatherv_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecV | None, root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Scatter_init(self, sendbuf: BufSpecB | None, recvbuf: Union[BufSpec, InPlace], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Scatterv_init(self, sendbuf: BufSpecV | None, recvbuf: Union[BufSpec, InPlace], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    ...
    def Reduce_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec | None, op: Op = SUM, root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    ...
    def Reduce_scatter_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, recvcounts: Sequence[int] | None = None, op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
    ...
    def reduce(self, sendobj: Any, op: Union[Op, Callable[[Any, Any], Any]] = SUM, root: int = 0) -> Any | None: ...
...
class Intracomm(Comm):
    def __new__(cls, comm: Comm | None = None) -> Intracomm: ...
    ...
    def Spawn(self, command: str, args: Sequence[str] | None = None, maxprocs: int = 1, info: Info = INFO_NULL, root: int = 0, errcodes: list | None = None) -> Intercomm: ...
    def Spawn_multiple(self, command: Sequence[str], args: Sequence[Sequence[str]] | None = None, maxprocs: Sequence[int] | None = None, info: Union[Info, Sequence[Info]] = INFO_NULL, root: int = 0, errcodes: list | None = None) -> Intercomm: ...
...
class Topocomm(Intracomm):
    def __new__(cls, comm: Comm | None = None) -> Topocomm: ...
...
class Cartcomm(Topocomm):
    def __new__(cls, comm: Comm | None = None) -> Cartcomm: ...
...
class Graphcomm(Topocomm):
    def __new__(cls, comm: Comm | None = None) -> Graphcomm: ...
...
class Distgraphcomm(Topocomm):
    def __new__(cls, comm: Comm | None = None) -> Distgraphcomm: ...
...
class Intercomm(Comm):
    def __new__(cls, comm: Comm | None = None) -> Intercomm: ...
    @classmethod
...
class Win:
    def __new__(cls, win: Win | None = None) -> Win: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    @classmethod
    def Create(cls, memory: Union[Buffer, Bottom], disp_unit: int = 1, info: Info = INFO_NULL, comm: Intracomm = COMM_SELF) -> Self: ...
    @classmethod
...
class File:
    def __new__(cls, file: File | None = None) -> File: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    def __reduce__(self) -> Union[str, tuple[Any, ...]]: ...
    @classmethod
    def Open(cls, comm: Intracomm, filename: Union[PathLike, str, bytes], amode: int = MODE_RDONLY, info: Info = INFO_NULL) -> Self: ...
    def Close(self) -> None: ...
    @classmethod
