...
class Request:
    ...
    @classmethod
    def testany(cls, requests: Sequence[Request], status: Optional[Status] = None) -> Tuple[int, bool, Any]: ...
    @classmethod
    def waitall(cls, requests: Sequence[Request], statuses: Optional[List[Status]] = None) -> List[Any]: ...
    @classmethod
    def testall(cls, requests: Sequence[Request], statuses: Optional[List[Status]] = None) -> Tuple[bool, List[Any]]: ...
    @classmethod
