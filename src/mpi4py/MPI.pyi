...
class Intracomm(Comm):
    ...
    def Spawn(self, command: PathLike[AnyStr], args: Sequence[str] | None = None, maxprocs: int = 1, info: Info = INFO_NULL, root: int = 0, errcodes: list[int] | None = None) -> Intercomm: ...
    def Spawn_multiple(self, command: Sequence[PathLike[AnyStr]], args: Sequence[Sequence[str]] | None = None, maxprocs: Sequence[int] | None = None, info: Sequence[Info] | Info = INFO_NULL, root: int = 0, errcodes: list[list[int]] | None = None) -> Intercomm: ...
