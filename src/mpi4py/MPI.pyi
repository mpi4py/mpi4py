...
class Intracomm(Comm):
    ...
    def Spawn_multiple(self, command: Sequence[str], args: Sequence[Sequence[str]] | None = None, maxprocs: Sequence[int] | None = None, info: Info | Sequence[Info] = INFO_NULL, root: int = 0, errcodes: list | None = None) -> Intercomm: ...
...
class File:
    ...
    def __reduce__(self) -> str | tuple[Any, ...]: ...
    @classmethod
    def Open(cls, comm: Intracomm, filename: PathLike | str | bytes, amode: int = MODE_RDONLY, info: Info = INFO_NULL) -> Self: ...
    def Close(self) -> None: ...
    @classmethod
    def Delete(cls, filename: PathLike | str | bytes, info: Info = INFO_NULL) -> None: ...
