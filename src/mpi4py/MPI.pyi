...
class Intracomm(Comm):
    ...
    def Spawn_multiple(self, command: Sequence[str], args: Sequence[Sequence[str]] | None = None, maxprocs: Sequence[int] | None = None, info: Info | Sequence[Info] = INFO_NULL, root: int = 0, errcodes: list[int] | None = None) -> Intercomm: ...
