...
FLOAT16_T: Final[Datatype] = ...
FLOAT32_T: Final[Datatype] = ...
FLOAT64_T: Final[Datatype] = ...
BFLOAT16_T: Final[Datatype] = ...
...
class Comm:
    ...
    def Create(self: Comm | CommT, group: Group) -> CommT: ...
    def Split(self: Comm | CommT, color: int = 0, key: int = 0) -> CommT: ...
    def Split_type(self: Comm | CommT, split_type: int, key: int = 0, info: Info = INFO_NULL) -> CommT: ...
    def Free(self) -> None: ...
    ...
    def Bsend_init(self, buf: BufSpec, dest: int, tag: int = 0) -> Prequest: ...
    def Ssend_init(self, buf: BufSpec, dest: int, tag: int = 0) -> Prequest: ...
    def Rsend_init(self, buf: BufSpec, dest: int, tag: int = 0) -> Prequest: ...
...
class Intracomm(Comm):
    ...
    def Create_cart(self, dims: Sequence[int], periods: Sequence[bool] | bool | None = None, reorder: bool = False) -> Cartcomm: ...
    def Create_graph(self, index: Sequence[int], edges: Sequence[int], reorder: bool = False) -> Graphcomm: ...
    def Create_dist_graph_adjacent(self, sources: Sequence[int] | None, destinations: Sequence[int] | None, sourceweights: Sequence[int] | int | None = None, destweights: Sequence[int] | int | None = None, info: Info = INFO_NULL, reorder: bool = False) -> Distgraphcomm: ...
    def Create_dist_graph(self, sources: Sequence[int], degrees: Sequence[int], destinations: Sequence[int], weights: Sequence[int] | int | None = None, info: Info = INFO_NULL, reorder: bool = False) -> Distgraphcomm: ...
    def Create_intercomm(self, local_leader: int, peer_comm: Intracomm, remote_leader: int, tag: int = 0) -> Intercomm: ...
    def Cart_map(self, dims: Sequence[int], periods: Sequence[bool] | bool | None = None) -> int: ...
    ...
    def Spawn(self, command: PathLike[AnyStr] | str | bytes, args: Sequence[str] | None = None, maxprocs: int = 1, info: Info = INFO_NULL, root: int = 0, errcodes: list[int] | None = None) -> Intercomm: ...
    def Spawn_multiple(self, command: Sequence[PathLike[AnyStr] | str | bytes], args: Sequence[Sequence[str]] | None = None, maxprocs: Sequence[int] | int | None = None, info: Sequence[Info] | Info = INFO_NULL, root: int = 0, errcodes: list[list[int]] | None = None) -> Intercomm: ...
    def Accept(self, port_name: str | None, info: Info = INFO_NULL, root: int = 0) -> Intercomm: ...
    def Connect(self, port_name: str | None, info: Info = INFO_NULL, root: int = 0) -> Intercomm: ...
...
class Intercomm(Comm):
    def __new__(cls, comm: Comm | None = None) -> Self: ...
    @classmethod
    def Create_from_groups(cls, local_group: Group, local_leader: int, remote_group: Group, remote_leader: int, stringtag: str = 'org.mpi4py', info: Info = INFO_NULL, errhandler: Errhandler | None = None) -> Intercomm: ...
...
def Register_datarep(datarep: str, read_fn: Callable[[Buffer, Datatype, int, Buffer, int], None] | None, write_fn: Callable[[Buffer, Datatype, int, Buffer, int], None] | None, extent_fn: Callable[[Datatype], int]) -> None: ...
