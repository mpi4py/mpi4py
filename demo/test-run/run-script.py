...
parser.add_option(
    "--rank", action='store', type='int',
    dest="rank", default=0,
)
parser.add_option(
    "--interrupt", action='store_true',
    dest="interrupt", default=False,
)
parser.add_option(
    "--sys-exit", action='store', type='int',
    dest="sys_exit", default=None,
)
parser.add_option(
    "--sys-exit-msg", action='store', type='string',
    dest="sys_exit", default=None,
)
parser.add_option(
    "--exception", action='store', type='string',
    dest="exception", default=None,
)
