# -*- coding: utf-8 -*-
#
# mpi4py documentation build configuration file, created by
# sphinx-quickstart on Thu Jan 19 17:29:48 2017.
#
...
version = mpi4py_version[:3]
# The full version, including alpha/beta/rc tags.
release = mpi4py_version
...
latex_documents = [
  ('manual', 'mpi4py.tex', u'MPI for Python', author, 'howto'),
]
...
man_pages = [
    ('manual', 'mpi4py', u'MPI for Python', [author], 1)
]
...
texinfo_documents = [
  ('manual', 'mpi4py', u'MPI for Python', author,
