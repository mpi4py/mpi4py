...
if "sphinx_rtd_theme" not in extensions and sphinx_rtd_theme is not None:
...
if "sphinx_copybutton" not in extensions and sphinx_copybutton is not None:
...
def _setup_numpy_typing():
    ...
    try:
        npt = importlib.import_module("numpy.typing")
    except ImportError:
